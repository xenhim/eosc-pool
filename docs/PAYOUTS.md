...
Address: 0x63fc6bf24415D69FD03B4eABa425A4fB3310ccc7, Amount: 166798415 Shannon, 2016-05-11 08:14:34
```

followed by

```
Credited 166798415 Shannon back to 0x63fc6bf24415D69FD03B4eABa425A4fB3310ccc7
```
...
> 1) "0x63fc6bf24415D69FD03B4eABa425A4fB3310ccc7:25000000"
...
eth.sendTransaction({
  from: eth.coinbase,
  to: '0x63fc6bf24415D69FD03B4eABa425A4fB3310ccc7',
...
```
ZADD "eth:payments:all" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:0x63fc6bf24415D69FD03B4eABa425A4fB3310ccc7:25000000
```

```
ZADD "eth:payments:0x63fc6bf24415D69FD03B4eABa425A4fB3310ccc7" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:25000000
```

### Delete Erroneous Payment Entry

```
ZREM "eth:payments:pending" "0x63fc6bf24415D69FD03B4eABa425A4fB3310ccc7:25000000"
```
